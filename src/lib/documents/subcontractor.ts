...
export const CONTRACTOR_INDUCTION = {
  ...
  sections: [
    ...
    { heading: 'Emergency procedures', bullets: ['Emergency: 000 · Poisons Information Centre: 13 11 26', 'Delta Cleaning Management: 0412 844 237', 'Know the site’s exits and evacuation points'] },
