      ...
      {signed ? (
        <div className="space-y-2.5">
          ...
          <div className="flex items-center gap-3 pt-1">
            {shownLink && <a href={shownLink} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-xs font-semibold text-[#00250e] hover:underline"><ExternalLink className="w-3.5 h-3.5" /> Open signed pack</a>}
          </div>
        </div>
      ) : (
        <div>
          ...
          {shownLink && (
            <div className="flex items-center gap-2 rounded-lg bg-gray-50 border border-gray-200 px-3 py-2 mb-2">
              ...
              <button onClick={() => copy(shownLink)} className="text-xs font-semibold text-[#00250e] inline-flex items-center gap-1">
